  ...
  always @* begin
    ...
    case (M_state_q)
      ...
      TEST1_state: begin
        ...
        if (M_adder_out == 16'h0990 && M_sc_inc_state == 1'h1) begin
      ...
      TEST2_state: begin
        ...
        if (M_adder_out == 16'h1d6e && M_sc_inc_state == 1'h1) begin
      ...
      TEST3_state: begin
        ...
        if (M_adder_out == 16'h0781 && M_sc_inc_state == 1'h1) begin
      ...
      TEST4_state: begin
        ...
        if (M_adder_out == 16'h0000 && M_sc_inc_state == 1'h1) begin
      ...
      TEST5_state: begin
        ...
        if (M_adder_out == 16'hff49 && M_sc_inc_state == 1'h1) begin
      ...
      TEST6_state: begin
        ...
        if (M_adder_out == 16'h8000 && M_sc_inc_state == 1'h1) begin
      ...
      TEST7_state: begin
        ...
        if (M_adder_out == 16'hfffe && M_sc_inc_state == 1'h1) begin
      ...
      TEST9_state: begin
        ...
        if (M_adder_out == 16'hcf8b && M_sc_inc_state == 1'h1) begin
      ...
      TEST10_state: begin
        ...
        if (M_adder_out == 16'hef71 && M_sc_inc_state == 1'h1) begin
      ...
      TEST11_state: begin
        ...
        if (M_adder_out == 16'hbfe9 && M_sc_inc_state == 1'h1) begin
      ...
      TEST13_state: begin
        ...
        if (M_adder_out == 16'h0761 && M_sc_inc_state == 1'h1) begin
      ...
      TEST14_state: begin
        ...
        if (M_adder_out == 16'h7fff && M_sc_inc_state == 1'h1) begin
      ...
      TEST15_state: begin
        ...
        if (M_adder_out == 16'h0001 && M_sc_inc_state == 1'h1) begin
